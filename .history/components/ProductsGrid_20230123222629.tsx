  ...
  return (
    ...
    >
      {people.map((person) => (
        <li
          key={person.button}
          className='flex flex-col col-span-1 text-center bg-white rounded-lg shadow max-w-[218px]'
        >
          ...
          <div>
            <div className='flex items-center justify-center h-[32px] space-x-4 bg-blue-500 rounded-b-md'>
