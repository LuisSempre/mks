      ...
      <div>
        ...
        <div className='flex flex-col flex-1 pl-64'>
          <div className='sticky top-0 z-10 flex flex-shrink-0 h-16 bg-white shadow'>
            <button
              type='button'
              className='hidden px-4 text-gray-500 border-r border-gray-200 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-50 first-letter'
            ...
            <div className='flex justify-between flex-1 px-4'>
              <div className='flex flex-1'>
                <form className='flex w-full ml-0' action='#' method='GET'>
              ...
              <div className='flex items-center ml-4 ml-6'>
                <button
                  type='button'
