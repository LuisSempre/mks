      ...
      {people.map((person) => (
        ...
        >
          <div className='flex flex-col p-4'>
            ...
            <small className='mt-2 text-xs text-left text-[#2C2C2C] font-thin'>
              {person.role}
            </small>
          </div>
          <div className='mt-3 py-2 flex items-center justify-center h-[32px] space-x-4 bg-[#0F52BA] rounded-b-md'>
