    ...
    >
      {people.map((person) => (
        ...
        >
          ...
          <div>
            <div className='flex items-center bg-blue-500 rounded-b-md'>
              <Image src={person.icon} alt='' className='w-4 h-4' unoptimized />
              <a className='relative inline-flex items-center justify-center flex-1 w-0 py-4 -mr-px text-sm font-medium text-[#FFFFFF] uppercase border border-transparent rounded-bl-lg hover:text-gray-500'>
                {person.button}
              </a>
            </div>
          </div>
