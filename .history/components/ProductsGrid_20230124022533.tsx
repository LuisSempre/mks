...
export default function ProductGrid() {
  return (
    <ul
      role='list'
      className='grid grid-cols-1 gap-6 sm:gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4'
    >
      {people.map((person) => (
        <li
          key={person.button}
        ...
        >
          <div className='flex flex-col p-3 space-y-2'>
            ...
            <div className='flex place-items-start'>
              ...
              <p className='px-2 font-bold text-md text-white bg-[#373737] rounded-md items-center justify-center flex'>
                {person.price}
              </p>
            </div>
