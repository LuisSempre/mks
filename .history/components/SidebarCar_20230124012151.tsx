  ...
  return (
    <>
      <div>
        ...
        <div className='flex md:hidden md:fixed md:inset-y-0 md:w-64 md:flex-col'>
        ...
        <div className='flex flex-col flex-1 md:pl-64'>
          <div className='sticky top-0 z-10 flex flex-shrink-0 h-16 bg-white shadow'>
            <button
              type='button'
              className='hidden px-4 text-gray-500 border-r border-gray-200 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500'
